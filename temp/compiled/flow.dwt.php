                ...
                <div class="cart-filter">
                    ...
                    <div class="sp-area store-selector">
                        <div class="text-select" id="area_address" ectype="areaSelect">
                            ...
                            <div class="selector">
                            <!--<div class="selector-tit"><?php echo $this->_var['province_row']['region_name']; ?>&nbsp;<?php echo $this->_var['city_row']['region_name']; ?>&nbsp;<?php echo $this->_var['district_row']['region_name']; ?></div>-->
                        ...
                        <div class="cart-item" ectype="shopItem">
                            <div class="shop">
                                ...
                                <div class="shop-txt">
									...
									<a href="<?php echo $this->_var['goodsRu']['url']; ?>" class="shop-name self-shop-name"><?php echo $this->_var['goodsRu']['ru_name']; ?></a>
									<?php else: ?>
                                    <a href="<?php echo $this->_var['goodsRu']['url']; ?>" class="shop-name"><strong><?php echo $this->_var['goodsRu']['ru_name']; ?></strong></a>
									<?php endif; ?>
                                    
                                    <?php if ($this->_var['goodsRu']['is_IM'] == 1 || $this->_var['goodsRu']['is_dsc']): ?>
                                    	<a href="javascript:;" id="IM" onclick="openWin(this)" goods_id="<?php echo $this->_var['goods']['goods_id']; ?>" class="p-kefu<?php if ($this->_var['goodsRu']['ru_id'] == 0): ?> p-c-violet<?php endif; ?>" target="_blank"><i class="iconfont icon-kefu"></i></a>
                                    <?php else: ?>
                                    ...
                                    <div class="item-header" ectype="prpmoHeader">
                                        ...
                                        <div class="f-txt">
                                            ...
                                            <?php if ($this->_var['activity']['act_type_ext'] == 0): ?>
                                                ...
                                                <?php else: ?>
                                                <a href="coudan.php?id=<?php echo empty($this->_var['activity']['act_id']) ? '0' : $this->_var['activity']['act_id']; ?>" class="ftx-03" target="_blank"><?php echo $this->_var['lang']['activity_notes_one']; ?><?php echo $this->_var['activity']['min_amount']; ?><?php echo $this->_var['lang']['yuan']; ?>，<?php echo $this->_var['lang']['receive_gifts']; ?> &gt; </a>
...
?>
                                    <div class="item-item" ectype="item">
                                        <div class="item-form">
                                            <div class="cell s-checkbox">
                                                <div class="cart-checkbox  <?php echo $this->_var['goods']['group_id']; ?>" ectype="ckList">
    ...
    foreach ($_from AS $this->_var['goods']):
?>
                                    <div class="item-item zp" ectype="item">
                                        <div class="item-form">
                                            <div class="cell s-checkbox">&nbsp;
...
?>
    ...
    foreach ($_from AS $this->_var['goods']):
?>
                                	<div class="item-item<?php if ($this->_var['goods']['group_id'] && $this->_var['goods']['parent_id'] != 0): ?> zp <?php echo $this->_var['goods']['group_id']; ?><?php endif; ?>" ectype="item" id="product_<?php echo $this->_var['goods']['goods_id']; ?>" data-goodsid="<?php echo $this->_var['goods']['goods_id']; ?>">
                                        <div class="item-form">
                                            <div class="cell s-checkbox">
                            ...
                            <div class="item<?php if (! $this->_var['store_seller']): ?> hide<?php endif; ?>" ectype="get_seller_sotre">
                                ...
                                <div class="item_value">
                                	<select id="selProvinces" onchange="region.changed(this, 2, 'selCities')">
                                        <option value=''><?php echo $this->_var['lang']['all_option']; ?></option>
...
?>
                                    ...
                                    <select  id="selDistricts" style="display:none" onchange="get_store_list(this,'flow','<?php echo $this->_var['cart_value']; ?>')">
                                        <option value=''><?php echo $this->_var['lang']['all_option']; ?></option>
                                        <?php $_from = $this->_var['city']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'region');if (count($_from)):
    foreach ($_from AS $this->_var['region']):
?>
                                        <option value="<?php echo $this->_var['region']['region_id']; ?>" <?php if ($this->_var['region']['region_id'] == 369): ?>selected<?php endif; ?>><?php echo $this->_var['region']['region_name']; ?></option>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </select>
                                    <span id="seller_soter" ectype="seller_soter"></span>
                            ...
                            <div class="item">
                            	...
                            	<div class="item_value">
                                	<div class="text_time"><input name="take_time" id="time_shop" type="text" class="text" data-val="<?php echo $this->_var['store_info']['take_time']; ?>" value="<?php echo $this->_var['store_info']['take_time']; ?>" readonly onblur="checked_store_info()"></div>
                                </div>
                            </div>
                            <div class="item">
                            	<div class="item_label"><?php echo $this->_var['lang']['phone_con']; ?>：</div>
                            	<div class="item_value"><input type="text" class="text text-2" data-val="<?php echo $this->_var['store_info']['store_mobile']; ?>" value="<?php echo $this->_var['store_info']['store_mobile']; ?>" name='store_mobile' placeholder="<?php echo $this->_var['lang']['store_take_mobile']; ?>"onblur="checked_store_info()"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ck-step-cont">
                    	<div class="payment-warp">
                            <div class="payment-list" ectype="paymentType">
                                <?php if ($this->_var['is_presale_goods'] != 1): ?>
...
?>
										<?php if ($this->_var['payment']['pay_code'] == 'onlinepay'): ?>
                                            <div class="p-radio-item payment-item <?php if ($this->_var['order']['pay_id'] == $this->_var['payment']['pay_id']): ?>selected <?php if ($this->_var['cod_disabled'] && $this->_var['payment']['is_cod'] == 1): ?>hide<?php endif; ?><?php else: ?><?php if ($this->_var['cod_disabled'] && $this->_var['payment']['is_cod'] == 1): ?>hide<?php endif; ?><?php endif; ?>" data-value='{"type":"<?php echo $this->_var['payment']['pay_code']; ?>","payid":"<?php echo $this->_var['payment']['pay_id']; ?>"}'>
                                                <span>
                                                    <input type="radio" <?php if ($this->_var['order']['pay_id'] == $this->_var['payment']['pay_id']): ?>checked<?php endif; ?> isCod="<?php echo $this->_var['payment']['is_cod']; ?>" name="payment" class="ui-radio" value="<?php echo $this->_var['payment']['pay_id']; ?>" />
                                                    <input type="radio" <?php if ($this->_var['order']['pay_id'] == $this->_var['payment']['pay_id']): ?>checked<?php endif; ?> name="pay_code" class="ui-radio" value="<?php echo $this->_var['payment']['pay_code']; ?>" />
                                                    <?php echo $this->_var['payment']['pay_name']; ?>
				...
				<?php if ($this->_var['config']['can_invoice']): ?>
                <div class="ck-step">
                	<div class="ck-step-tit">
                    ...
                    <div class="ck-step-cont">
                    	<div class="other-warp">
                            <div class="other-list">
                                ...
                                <div class="qt_item" id="qt_balance" <?php if ($this->_var['order']['pay_id'] == $this->_var['payment']['pay_id']): ?> style="display:none"<?php endif; ?>>
                                    <div class="item_label"><?php echo $this->_var['lang']['use_surplus']; ?>：</div>
                                    <div class="item_value">
                                        <input type="text" class="qt_text" name="surplus" id="ECS_SURPLUS" size="10" value="<?php echo $this->_var['order']['surplus']; ?>" onblur="changeSurplus(this.value)" <?php if ($this->_var['disable_surplus']): ?>disabled="disabled"<?php endif; ?> />
                                ...
                                <div class="qt_item" id="qt_onlinepay">
                                    ...
                                    <div class="item_value">
                                        ...
                                        <input type="password" class="qt_text" name="pay_pwd" size="20" value="" onblur="get_pay_pwd(this.value, 0);" />
                                        <input name="pay_pwd_error" type="hidden" id="pwd_error" value="<?php echo $this->_var['pay_pwd_error']; ?>" />
...
?>
                                        ...
                                        <div class="radio-item">
                                            <input type="radio" name="how_oos" class="ui-radio" value="<?php echo $this->_var['how_oos_id']; ?>" <?php if ($this->_var['order']['how_oos'] == $this->_var['how_oos_id']): ?>checked<?php endif; ?> id="checkbox_<?php echo $this->_var['how_oos_id']; ?>" onclick="changeOOS(this)">
                ...
                <div class="ck-step">
                    ...
                    <div class="ck-step-cont" style="display:none;">
                        ...
                        <div class="toggle-panel-main">
                            ...
                            <div class="toggle-panl-warp panl-coupon">
                            	<?php if ($this->_var['user_coupons']): ?>
                                <div class="panl-top">
                                	<div class="panl-items">
                                    <?php $_from = $this->_var['user_coupons']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'vo');$this->_foreach['user_coupons'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['user_coupons']['total'] > 0):
    foreach ($_from AS $this->_var['vo']):
        $this->_foreach['user_coupons']['iteration']++;
?>
                                        <div class="panl-item<?php if ($this->_foreach['user_coupons']['iteration'] % 4 == 0): ?> panl-item-last<?php endif; ?>" ectype="panlItem" data-ucid="<?php echo $this->_var['vo']['uc_id']; ?>" data-type="coupons">
                                            <i class="i-left"></i>
                                            <div class="panl-item-warp">
                                                <div class="panl-item-top">
                                                    <strong>￥<?php echo $this->_var['vo']['cou_money']; ?></strong>
                                                    <span><?php echo $this->_var['lang']['full']; ?><?php echo $this->_var['vo']['cou_man']; ?></span>
                                                </div>
                                                <div class="panl-item-bot">
                                                    <p><?php echo $this->_var['lang']['range_bonus']; ?>：[<?php echo $this->_var['vo']['cou_type']; ?>][<?php echo $this->_var['vo']['cou_goods_name']; ?>]</p>
                                                    <p>商家：<?php echo $this->_var['vo']['shop_name']; ?></p>
                                                    <p><?php echo $this->_var['lang']['overdue_time']; ?><?php echo $this->_var['vo']['cou_end_time']; ?></p>
                                                </div>
                                            </div>
                                            <i class="i-right"></i>
                                            <b></b>
                            	...
                            	<?php if ($this->_var['coupons_list']): ?>
                                <div class="panl-bot">
                                	<div class="panl-items">
                                    <?php $_from = $this->_var['coupons_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'vo');$this->_foreach['coupons_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['coupons_list']['total'] > 0):
    foreach ($_from AS $this->_var['vo']):
        $this->_foreach['coupons_list']['iteration']++;
?>
                                        <div class="panl-item panl-item-disabled<?php if ($this->_foreach['coupons_list']['iteration'] % 4 == 0): ?> panl-item-last<?php endif; ?>">
                                            <i class="i-left"></i>
                                            <div class="panl-item-warp">
                                                <div class="panl-item-top">
                                                    <strong>￥<?php echo $this->_var['vo']['cou_money']; ?></strong>
...
?>
                                    ...
                                    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    <input name="value_card_psd" id="value_card_psd" type="text" class="qt_text2 order_vc_psd hide" size="15" value="" />
                                    <input name="validate_value_card" type="button" class="hide" id="bnt_bonus_sn" value="<?php echo $this->_var['lang']['bind_value_card']; ?>" onclick="validateVcard($('.order_vc_psd').val())" />
...
?>
                        ...
                        <input type="hidden" name="bonus" id="bonus_id" value="">
                        <input type="hidden" name="vc_id" id="ECS_VALUE_CARD" value="">
                    </div>
                </div>    
                <?php endif; ?>
            ...
            <div class="payOrder-warp" id="pay_main">
                <div class="payOrder-desc">
                    ...
                    <div class="pay-txt">
                        ...
                        <p><span><?php echo $this->_var['lang']['checkout_success_two']; ?><em><?php echo $this->_var['order_count']; ?></em><?php echo $this->_var['lang']['checkout_success_three']; ?>：</span></p>
                        <?php endif; ?>
                    </div>
                    <div class="o-list">
                        <div class="o-list-info">
                            <span id="shdz"><?php echo $this->_var['lang']['Send_to']; ?>：<?php echo $this->_var['order']['region']; ?></span>
                ...
                <div class="payOrder-mode">
                    ...
                    <?php else: ?>
                        <?php if ($this->_var['is_alipay_bank']): ?>
                        <div class="payOrder-list">
                            
                            <div class="p-mode-tit">
                                <h3><?php echo $this->_var['lang']['bank_cord']; ?>支付</h3>
                            </div>
                            <div class="p-mode-list bank_list" ectype="bankList">
                            	<ul>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="CMB"><input checked="checked" type="hidden" value="alipay_cmb" id="CMB" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_zsyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="ICBCB2C"><input type="hidden" value="alipay_icbcb2c" id="ICBCB2C" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_gsyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="CCB"><input type="hidden" value="alipay_ccb" id="CCB" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_jsyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="ABC"><input type="hidden" value="alipay_abc" id="ABC" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_nyyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="BOC-DEBIT"><input type="hidden" value="alipay_bocb2c" id="BOC-DEBIT" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_zgyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="COMM"><input type="hidden" value="alipay_comm" id="COMM" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_jtyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="PSBC-DEBIT"><input type="hidden" value="alipay_psbc" id="PSBC-DEBIT" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_youzheng.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="GDB"><input type="hidden" value="alipay_gdb" id="GDB" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_gfyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="SPDB"><input type="hidden" value="alipay_spdb" id="SPDB" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_pufa.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="CEBBANK"><input type="hidden" value="alipay_cebbank" id="CEBBANK" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_gdyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="SPABANK"><input type="hidden" value="alipay_spabank" id="SPABANK" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_payh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="CIB"><input type="hidden" value="alipay_cib" id="CIB" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_xyyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="CMBC"><input type="hidden" value="alipay_cmbc" id="CMBC" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_msyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="CITIC"><input type="hidden" value="alipay_citic" id="CITIC" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_zxyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="SHBANK"><input type="hidden" value="alipay_shbank" id="SHBANK" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_shyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="BJRCB"><input type="hidden" value="alipay_bjrcb" id="BJRCB" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_bjnsyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="NBBANK"><input type="hidden" value="alipay_nbbank" id="NBBANK" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_nbyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="HZCBB2C"><input type="hidden" value="alipay_hzcbb2c" id="HZCBB2C" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_hzyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="SHRCB"><input type="hidden" value="alipay_shrcb" id="SHRCB" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_shnsyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="FDB"><input type="hidden" value="alipay_fdb" id="FDB" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_fcyh.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="BJBANK"><input type="hidden" value="alipay_bjbank" id="BJBANK" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_bjbank.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="WZCB"><input type="hidden" value="alipay_wzcb" id="WZCB" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_wzcb.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="ZJNX"><input type="hidden" value="alipay_zjnx" id="ZJNX" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_zjnx.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="CDCB"><input type="hidden" value="alipay_cdcb" id="CDCB" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_cdcb.gif"></label></a></li>
                                    <li><a href="javascript:void(0);" class="b-pay"><label for="CSRCB"><input type="hidden" value="alipay_csrcb" id="CSRCB" name="alipay_bank"> <img alt="" src="themes/ecmoban_dsc2017/images/alipay_bank/payOnline_CSRCB.gif"></label></a></li>
                            	</ul>
                            </div>
                            
                            <div class="pay_button" id="alipay_bank" order_sn="<?php echo $this->_var['order']['order_sn']; ?>" flag="alipay_bank">
                                
                                <a href="javascript:void(0);" class="noBtn"><?php echo $this->_var['lang']['immediately_pay']; ?></a>
                                
                                <?php echo $this->_var['is_alipay_bank']; ?>
                            </div>
                        </div>
                        <?php endif; ?>
                        <div class="payOrder-list">
            ...
            <div class="shopend-warp">
                ...
                <div class="shopend-info-many">
                    <div class="shopend-info">
                        ...
                        <div class="s-i-right">
                            <h3>
                            <?php if ($this->_var['order']['pay_name'] == '货到付款'): ?>
                                您选择的是货到付款，请联系客服
                            <?php elseif ($this->_var['order']['pay_name'] == '银行汇款/转帐'): ?>
                                您选择的是线下转账请转账后联系客服
                            <?php else: ?>
...
?>
                    ...
                    <div class="fd-total"><span><?php echo $this->_var['lang']['Total_amount_payable']; ?>：</span><div class="total-price"><?php echo $this->_var['total']['amount_formated']; ?></div></div>
...
?>
    ...
    <?php echo $this->smarty_insert_scripts(array('files'=>'jquery.SuperSlide.2.1.1.js,common.js,shopping_flow.js,warehouse.js,jquery.nyroModal.js,perfect-scrollbar/perfect-scrollbar.min.js')); ?>
	...
	<script type="text/javascript">
		$(function(){
			//默认加载支付方式类型
			if($("input[name='pay_code']:checked").val() == "onlinepay"){
				$("#qt_balance").hide();
			}else{
				$("#qt_balance").show();
			}
