...
?>
        <div class="cs-w-item<?php if ($this->_var['consignee']['address_id'] == $this->_var['address']['address_id']): ?> cs-selected<?php endif; ?>" data-addressid="<?php echo $this->_var['address']['address_id']; ?>" ectype="cs-w-item">
            ...
            <i class="icon"></i>
            <a href="javascript:void(0);" class="edit" ectype="dialog_checkout" data-value='{"divId":"edit_address","id":<?php echo $this->_var['address']['address_id']; ?>,"url":"flow.php?step=edit_Consignee","width":900,"title":"<?php echo $this->_var['lang']['edit_consignee_address']; ?>"}'>修改</a>
