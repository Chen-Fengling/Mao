...
?>
                <a href="user.php?act=oath&type=<?php echo $this->_var['website']['web_type']; ?>" class="qq"><b class="third-party-icon <?php echo $this->_var['website']['web_type']; ?>-icon"></b></a>
	...
	<?php $_from = $this->_var['user_lang']['passport_js']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'lang_0_84080900_1509031937');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['lang_0_84080900_1509031937']):
?>
	var <?php echo $this->_var['k']; ?>="<?php echo $this->_var['lang_0_84080900_1509031937']; ?>";
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		/* *
		 * 会员登录
		*/ 
		function userLogin()
		{
			...
			<?php if ($this->_var['is_jsonp'] && $this->_var['site_domain']): ?>
				...
				var post_url = "act=act_login&is_jsonp=" + <?php echo $this->_var['is_jsonp']; ?> + '&username=' + username.val()+'&password='+password.val()+'&captcha='+captcha.val()+'&back_act='+back_act;
