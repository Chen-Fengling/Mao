...
function loadTemplate(id)
{
	...
	$.jqueryAjax('alidayu_configure.php', 'act=loat_template&tpl=' + tpl + id, loadTemplateResponse, "GET", "JSON");
}
...
function get_sms_template(){
	...
	$.jqueryAjax('alidayu_configure.php', 'act=sms_template' + "&set_sign=" + set_sign + "&temp_id=" + temp_id + "&temp_content=" + temp_content + "&send_time=" + send_time + "&sms_type=" + sms_type, smsTemplateResponse, "GET", "JSON");
}
