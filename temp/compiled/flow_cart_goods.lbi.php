    ...
    <div class="ck-goods-item" ectype="shoppingList">
        <div class="ck-goods-tit">
            <div class="ck-store">
                ...
                <a href="javascript:;" id="IM" onclick="openWin(this)" goods_id="<?php echo $this->_var['goodsRu']['goods_id']; ?>" class="p-kefu <?php if ($this->_var['goodsRu']['ru_id'] == 0): ?> p-c-violet<?php endif; ?>" target="_blank"><i class="iconfont icon-kefu"></i></a>
                <?php else: ?>
                        ...
                        <?php if ($this->_var['goodsRu']['offline_store'] != ""): ?>
                            <div class="items">
                                ...
                                <div class="item">
                                    ...
                                    <div class="value"><?php if ($this->_var['goodsRu']['offline_store']['stores_img']): ?><a href="<?php echo $this->_var['goodsRu']['offline_store']['stores_img']; ?>" class="nyroModal ftx-05">查看</a><?php endif; ?></div>
                                </div>
                                <?php endif; ?>
                                <div class="item">
...
?>
                            ...
                            <li class="mode-tab-item mode-tab-log shopping-list-checked <?php if ($this->_var['goodsRu']['shipping_type'] == 0): ?>item-selected<?php endif; ?>" ectype="tabLog" data-ruid="<?php echo $this->_var['goodsRu']['ru_id']; ?>" data-type="0" data-shipping="<?php echo $this->_var['shipping']['shipping_id']; ?>" data-shippingcode="<?php echo $this->_var['shipping']['shipping_code']; ?>">
                            <span><?php echo $this->_var['shipping']['shipping_name']; ?></span>
                            </li>
                            <?php endif; ?>
                            ...
                            <li class="mode-tab-item shopping-list-checked <?php if ($this->_var['goodsRu']['shipping_type'] == 1): ?>item-selected<?php endif; ?>" ectype="tabCac" data-ruid="<?php echo $this->_var['goodsRu']['ru_id']; ?>" data-type="1" data-shipping="<?php echo $this->_var['goodsRu']['self_point']['shipping_id']; ?>" data-shippingcode="<?php echo $this->_var['goodsRu']['self_point']['shipping_code']; ?>">
                                <span><?php echo $this->_var['lang']['Door_self']; ?></span>
                            </li>
                            <?php endif; ?>
                        </ul>
...
?> 
                                    ...
                                    <li class="logistics_li <?php if ($this->_var['goodsRu']['tmp_shipping_id'] == $this->_var['shipping']['shipping_id']): ?>item-selected<?php endif; ?>" data-ruid="<?php echo $this->_var['goodsRu']['ru_id']; ?>" data-type="0" data-shipping="<?php echo $this->_var['shipping']['shipping_id']; ?>" data-shippingcode="<?php echo $this->_var['shipping']['shipping_code']; ?>" data-text="<?php echo $this->_var['shipping']['shipping_name']; ?>">
                                        <span><?php echo $this->_var['shipping']['shipping_name']; ?></span>
                                        <em>（<?php if ($this->_var['shipping']['shipping_fee']): ?><?php echo $this->_var['shipping']['format_shipping_fee']; ?><?php else: ?><?php echo $this->_var['lang']['Free_shipping']; ?><?php endif; ?>）</em>
                                    </li>
                                    <?php endif; ?>
                                    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
                                    <?php endif; ?>
					...
					<?php else: ?>
                    <span class="ftx-01">该地区暂不支持配送</span>
					<?php endif; ?>
                    <?php endif; ?>
                ...
                <div class="ck-prom-header">
                    <div class="f-txt">
                        ...
                        <?php elseif ($this->_var['activity']['act_type'] == 1): ?>
                            ...
                            <?php if ($this->_var['activity']['available']): ?>
                                <a href="javascript:;"><span><?php echo $this->_var['lang']['activity_notes_one']; ?><?php echo $this->_var['activity']['min_amount']; ?><?php echo $this->_var['lang']['yuan']; ?> ,<?php echo $this->_var['lang']['been_reduced']; ?><?php echo $this->_var['activity']['act_type_ext_format']; ?><?php echo $this->_var['lang']['cart_goods_four']; ?></span></a>
                            <?php else: ?>
                                <a href="javascript:;"><span><?php echo $this->_var['lang']['activity_notes_three']; ?><?php echo $this->_var['activity']['min_amount']; ?><?php echo $this->_var['lang']['cart_goods_five']; ?></span></a>
                            <?php endif; ?>

                        <?php elseif ($this->_var['activity']['act_type'] == 2): ?>
                            <?php if ($this->_var['activity']['available']): ?>
                                <a href="javascript:;"><span><?php echo $this->_var['lang']['activity_notes_one']; ?><?php echo $this->_var['activity']['min_amount']; ?><?php echo $this->_var['lang']['yuan']; ?> ，<?php echo $this->_var['lang']['Already_enjoy']; ?><?php echo $this->_var['activity']['act_type_ext_format']; ?><?php echo $this->_var['lang']['percent_off_Discount']; ?></span></a>
                            <?php else: ?>
                                <a href="javascript:;"><span><?php echo $this->_var['lang']['activity_notes_three']; ?><?php echo $this->_var['activity']['min_amount']; ?><?php echo $this->_var['lang']['zhekouxianzhi']; ?></span></a>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="cg-item<?php if (($this->_foreach['act_goods']['iteration'] <= 1)): ?> first<?php endif; ?>">
                    ...
                    <div class="c-col cg-state">
                        <span class="">
                            ...
                            <?php endif; ?>
							<?php if ($this->_var['goodsRu']['shipping'] || ! goods.is_real): ?>
								<input name="shipping_prompt" type="hidden" id="<?php echo $this->_var['goods']['rec_id']; ?>" value="0">
							<?php else: ?>
								<input name="shipping_prompt" type="hidden" id="<?php echo $this->_var['goods']['rec_id']; ?>" value="1">
							<?php endif; ?>
                        </span>
                    </div>
                    ...
                    <div class="c-col cg-state">
                        <span>
                            ...
                            <?php else: ?>
                                ...
                                <input name="rec_number" type="hidden" id="<?php echo $this->_var['goods']['rec_id']; ?>" value="1">
                            <?php endif; ?>
							<?php if ($this->_var['goodsRu']['shipping'] || ! $this->_var['goods']['is_real']): ?>
								<input name="shipping_prompt" type="hidden" id="<?php echo $this->_var['goods']['rec_id']; ?>" value="0">
							<?php else: ?>
								<input name="shipping_prompt" type="hidden" id="<?php echo $this->_var['goods']['rec_id']; ?>" value="1">
							<?php endif; ?>
